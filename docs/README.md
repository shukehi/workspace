...
1. 前后端/数据库通用约束：`ENGINEERING_CONVENTIONS.md`
2. 页面、store、配置域、请求校验、兼容层放置规则：`FEATURE_DEVELOPMENT_GOVERNANCE_2026-03-10.md`
3. 合并前自检清单：`PR_FEATURE_CHECKLIST_2026-03-10.md`
