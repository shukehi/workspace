...
1. 改库前一页式检查：`DB_CHANGE_CHECKLIST_2026-03-13.md`
2. 本地开发数据保护规则：`LOCAL_DEVELOPMENT_DATA_SAFETY_2026-03-13.md`
3. 当前阶段架构护栏：`CURRENT_ARCHITECTURE_GUARDRAILS_2026-03-13.md`
4. 前后端/数据库通用约束：`ENGINEERING_CONVENTIONS.md`
5. 页面、store、配置域、请求校验、兼容层放置规则：`FEATURE_DEVELOPMENT_GOVERNANCE_2026-03-10.md`
6. 合并前自检清单：`PR_FEATURE_CHECKLIST_2026-03-10.md`
