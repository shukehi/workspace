...
2. Run `node --require tsx/cjs --test tests/print-style-guard.test.ts`
...
2. If a change only affects print styles, prioritize print preview and `tests/print-style-guard.test.ts`.
