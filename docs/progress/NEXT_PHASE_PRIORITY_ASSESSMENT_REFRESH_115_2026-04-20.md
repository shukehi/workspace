# Next Phase Priority Assessment Refresh 115 (2026-04-20)

> 状态：当前有效。
> 触发点：`refactor/source-analysis-deeper-normalization-pass6` 已完成并并入 `main`。
...
pass 6 再次证明 source-analysis 还有清晰、低风险的小 seam：
- analyze orchestration 和 analysis failure / warning side-effects 可以分离
- 分离后 error/warning owner 更明确
...
建议下一条分支：
- `refactor/source-analysis-deeper-normalization-pass7`

优先候选：
- runtime / workflow 之间更小的 contract normalization
- workflow 中 remaining fetch/history error normalization 的再收束
