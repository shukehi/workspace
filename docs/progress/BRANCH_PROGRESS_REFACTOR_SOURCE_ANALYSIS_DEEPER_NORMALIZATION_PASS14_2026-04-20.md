# Branch Progress — refactor/source-analysis-deeper-normalization-pass14 (2026-04-20)

> 状态：已完成，可封板。
> 分支：`refactor/source-analysis-deeper-normalization-pass14`
> 计划：`docs/roadmaps/SOURCE_ANALYSIS_DEEPER_NORMALIZATION_PASS14_2026-04-20.md`
> 实现提交：`603af12`
...
- 将 currentOrder-derived selectors 提炼到独立 helper
- 让 `useSourceStore()` 更聚焦于 state/workflow/derived composition shell

结果：
- `src/features/source-analysis/composables/useSourceOrderSelectors.ts` 成为 currentOrder-derived selector owner
- store 不再内联 `hasOrder` / `orderItems`
- source-analysis store-facing selector ownership 继续变清晰
...
- `src/features/source-analysis/composables/useSourceOrderSelectors.ts`
- `tests/source-order-selectors.test.ts`
- `tests/materials-page-hardware-sections.test.ts`
- `docs/roadmaps/SOURCE_ANALYSIS_DEEPER_NORMALIZATION_PASS14_2026-04-20.md`
- `docs/README.md`
