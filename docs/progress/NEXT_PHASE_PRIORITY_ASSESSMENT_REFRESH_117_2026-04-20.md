# Next Phase Priority Assessment Refresh 117 (2026-04-20)

> 状态：当前有效。
> 触发点：`refactor/source-analysis-deeper-normalization-pass8` 已完成并并入 `main`。
...
pass 8 再次证明 source-analysis 还有清晰、低风险的小 seam：
- analyze orchestration 与 invocation owner 可以分离
- 分离后 currentOrder gating 和 invocation contract 更明确
...
建议下一条分支：
- `refactor/source-analysis-deeper-normalization-pass9`

优先候选：
- runtime / workflow 之间更小的 contract normalization
- workflow 中 remaining clear/reset owner 的再收束
