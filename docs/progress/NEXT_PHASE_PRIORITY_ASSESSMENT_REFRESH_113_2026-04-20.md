# Next Phase Priority Assessment Refresh 113 (2026-04-20)

> 状态：当前有效。
> 触发点：`refactor/source-analysis-deeper-normalization-pass4` 已完成并并入 `main`。
...
pass 4 再次证明 source-analysis 还有清晰、低风险的小 seam：
- workflow orchestration 和 contract cache side-effect application 可以分离
- 分离后 cache side-effect owner 更明确
...
建议下一条分支：
- `refactor/source-analysis-deeper-normalization-pass5`

优先候选：
- runtime / workflow 之间更小的 contract normalization
- workflow 中 remaining fetch / error-application owner 的再收束
