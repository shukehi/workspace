# Next Phase Priority Assessment Refresh 114 (2026-04-20)

> 状态：当前有效。
> 触发点：`refactor/source-analysis-deeper-normalization-pass5` 已完成并并入 `main`。
...
pass 5 再次证明 source-analysis 还有清晰、低风险的小 seam：
- workflow orchestration 和 request-state application 可以分离
- 分离后 loading/error owner 更明确
...
建议下一条分支：
- `refactor/source-analysis-deeper-normalization-pass6`

优先候选：
- runtime / workflow 之间更小的 contract normalization
- workflow 中 remaining analysis-error application / warning side-effect owner 的再收束
