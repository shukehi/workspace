...
router.get('/published-map', async (_req: Request, res: Response) => {
    try {
...
router.get('/:formulaKey', async (req: Request, res: Response) => {
    try {
...
router.put('/:formulaKey/draft', async (req: Request, res: Response) => {
    try {
...
router.post('/:formulaKey/publish', async (req: Request, res: Response) => {
    try {
...
router.post('/:formulaKey/archive', async (req: Request, res: Response) => {
    try {
...
router.post('/:formulaKey/rollback', async (req: Request, res: Response) => {
    try {
...
router.delete('/:formulaKey', async (req: Request, res: Response) => {
    try {
...
router.get('/:formulaKey/revisions', async (req: Request, res: Response) => {
    try {
