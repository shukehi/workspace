...
// @ts-expect-error shared CJS validator core is consumed by both frontend and backend
import sharedMappingValidatorCore from '../../../shared/mappings/mapping-validator-core.js';
