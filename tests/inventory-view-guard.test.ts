...
test('inventory view guard: shows inventory receipts section with order filter support', () => {
  ...
  const locationSubmitState = read('src/features/inventory/composables/useInventoryLocationSubmitState.ts');
  ...
  assert.doesNotMatch(view, /useInventoryPageState/);
  assert.doesNotMatch(view, /useInventoryOutboundState/);
  assert.match(view, /useInventoryOutboundQueryState/);
  assert.match(view, /useInventoryOutboundListState/);
  assert.match(view, /useInventoryOutboundReverseState/);
  assert.match(view, /useInventoryOutboundDetailState/);
  assert.match(view, /useInventoryOutboundSubmitState/);
  ...
  assert.match(receiptListState, /fetchAllInventoryReceipts/);
  assert.match(view, /useInventoryReceiptRouteState/);
  assert.doesNotMatch(view, /useInventoryReceiptFlow/);
  assert.match(view, /useInventoryReceiptListState/);
  assert.match(receiptListState, /export function useInventoryReceiptListState/);
  assert.match(receiptListState, /const filteredReceipts = computed/);
  assert.match(receiptListState, /const receiptSummary = computed/);
  assert.match(receiptListState, /const receiptTotalPages = computed/);
  assert.match(receiptListState, /async function loadReceipts/);
  assert.match(receiptListState, /function handleExportReceipts/);
  assert.match(receiptListState, /function nextReceiptPage/);
  assert.match(receiptListState, /function prevReceiptPage/);
  assert.match(view, /buildReceiptFetchParams/);
  assert.match(view, /clearReceiptRouteFilters/);
  assert.match(receiptListState, /fetchInventoryReceipts/);
  assert.match(receiptListState, /exportReceiptsToCSV/);
  assert.match(receiptListState, /loadReceipts/);
  assert.match(receiptListState, /入库记录加载失败/);
  ...
  assert.match(pageListState, /async function loadInventoryList/);
  assert.match(movementDetailState, /async function openMovementSheet/);
  assert.match(movementDetailState, /fetchInventoryMovements/);
  assert.match(pageListState, /function handleExportInventory/);
  assert.match(pageListState, /function handleExportReconciliation/);
  ...
  assert.match(view, /useInventoryLocationSubmitState/);
  assert.match(locationSubmitState, /export function useInventoryLocationSubmitState/);
  assert.match(locationSubmitState, /const locationDialogSaving = ref/);
  assert.match(locationSubmitState, /async function handleLocationSubmit/);
  assert.match(locationSubmitState, /fetchInventoryLocations/);
