...
test('inventory view guard: shows inventory receipts section with order filter support', () => {
  ...
  assert.match(store, /const movementsTotal = ref/);
  assert.match(store, /const movementsPage = ref/);
  assert.match(store, /const movementsPageSize = ref/);
